...
__all__ = [
    'VGG', 'vgg19_bn_attention', 'vgg19_attention',
]
...
def vgg19_attention(pretrained=False, in_channels=3, **kwargs):
...
def vgg19_bn_attention(pretrained=False, in_channels=3, **kwargs):
